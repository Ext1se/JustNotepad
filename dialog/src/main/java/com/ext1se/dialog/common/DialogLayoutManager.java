...
public class DialogLayoutManager extends GridLayoutManager {

    private static final String TAG = DialogLayoutManager.class.getSimpleName();

    private int iconSize;

    public DialogLayoutManager(Context context, int iconSize) {
